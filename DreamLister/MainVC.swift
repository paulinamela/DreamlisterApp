...
class MainVC: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    func attemptFetch() {
        ...
        controller.delegate = self // aby bylo wiadomo do czego zastosowac metody, bez tego widok nie bedzie sie odswiezal
    ...
    func generateTestData() {
        ...
        item.price = 4000
        item.details = "I would love to have a new MBP!"
        
        let item2 = Item(context: context)
        item2.title = "Koala"
        item2.price = 0
        item2.details = "My dream is to adopt a koala one day."
